...
// Meditações do Método de São Luís de Montfort
export const MONTFORT = {
        ...
        mysteries: [
            {
                ...
                aves: [
                    "Para lamentar o desgraçado estado de Adão.",
                    "Os desejos dos patriarcas.",
                    "Os desejos de Maria.",
                    "A caridade do Pai.",
                    "O amor do Filho.",
                    "A embaixada do anjo.",
                    "O temor de Maria.",
                    "O consentimento de Maria.",
                    "A criação da alma de Jesus.",
            ...
            },
            {
                ...
                aves: [
                    ...
                    "As complacências de Jesus.",
                    "A dúvida de São José.",
                    "A eleição dos escolhidos.",
                    "O fervor na visita.",
                    "A santificação de João.",
                    "A gratidão no Magnificat.",
                    "A caridade em servir.",
                    "A mútua dependência."
                ]
            },
            {
                ...
                aves: [
                    "Os desprezos em Belém.",
                    "A pobreza do estábulo.",
                    "A alta contemplação.",
                    "A saída do Verbo.",
                    "Adorações dos anjos.",
                    "Formosura da infância.",
                    "Vinda dos pastores.",
                    "A circuncisão.",
                    "Imposição do nome.",
                    "Adoração dos magos."
    ...
    dolorosos: {
        ...
        mysteries: [
            {
                title: "A Agonia",
                pater: "A felicidade de Deus.",
                aves: [
                    "Retiros de Jesus.",
                    "Orações fervorosas.",
                    "Paciência com apóstolos.",
                    "Tédio da alma.",
                    "Suor de sangue.",
                    "Consolo do anjo.",
                    "Conformidade com o Pai.",
                    "Traição e prisão.",
                    "Valor no encontro.",
                    "Abandono."
                ]
            ...
            {
                title: "A Cruz",
                pater: "A onipotência de Deus.",
                aves: [
                    "Eis o Homem.",
                    "Preferido a Barrabás.",
                    "Falsos testemunhos.",
                    "Condenação.",
                    "Amor à Cruz.",
                    "Trabalho ao carregar.",
                    "Quedas.",
                    "Encontro com Maria.",
                    "Véu de Verônica.",
                    "Lágrimas."
        ...
        mysteries: [
            {
                ...
                pater: "A eternidade de Deus.",
                aves: [
                    "Descida aos infernos.",
                    "Gozo dos Santos Padres.",
                    "Reunião alma e corpo.",
                    "Saída do sepulcro.",
                    "Vitórias.",
                    "Dons gloriosos.",
                    "Poder de Jesus.",
            ...
            },
            {
                ...
                aves: [
                    ...
                    "Maternidade divina.",
                    "Morte de amor.",
                    "Ressurreição e assunção."
                ]
            },
            {
                title: "A Coroação",
                pater: "A glória de Deus.",
                aves: [
                    "Tríplice coroa.",
                    "Gozo do Céu.",
                    "Rainha do Céu.",
